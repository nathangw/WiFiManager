...
const char HTTP_UPDATE[] PROGMEM = "Upload new firmware<br/><form method='POST' action='u' enctype='multipart/form-data' onchange=\"(function(el){document.getElementById('uploadbin').style.display = el.value=='' ? 'none' : 'initial';})(this)\"><input type='file' name='update' accept='.bin,application/octet-stream'><button id='uploadbin' type='submit' class='h D'>Update</button></form><small><a href='http://161.161.161.161/update' target='_blank'>* May not function inside captive portal, click here to open in browser http://161.161.161.161</a><small>";
...
const char HTTP_INFO_aboutver[]     PROGMEM = "<dt>ChargeMailer</dt><dd>{1}</dd>";   //Put the product brand name here
...
const char S_brand[]              PROGMEM = "ChargeMailer";   //Put the product brand name here
